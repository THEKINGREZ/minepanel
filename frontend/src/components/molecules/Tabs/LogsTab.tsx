      ...
      <div className="lg:col-span-2 space-y-2 px-6">
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <Input placeholder="Buscar en logs..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10 bg-gray-800/70 border-gray-700/50 text-gray-200 placeholder-gray-400 focus:border-emerald-500/50" />
          </div>
    ...
    <CardContent className="pb-2">
      <div className="bg-red-900/40 border border-red-700/50 rounded-md p-3 mb-4">
        <div className="flex items-center">
          ...
          <div>
            <p className="text-sm font-medium text-red-200">{error ? "Error en los logs" : "Error en los recursos"}</p>
      ...
      <div className="bg-yellow-900/40 border border-yellow-700/50 rounded-md p-3 mb-4">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-yellow-300 mt-1">Se encontraron errores o excepciones en los logs del servidor</p>
          </div>
        </div>
      </div>
    </CardContent>
          ...
          <div>
            ...
            {(() => {
              ...
              if (loadingResources) {
                ...
                cpuContent = <span className="text-red-400">Error</span>;
              } else if (resources?.status !== "running" && resources?.cpuUsage === "N/A") {
                cpuContent = "Servidor inactivo";
              } else {
          ...
          <div>
            ...
            {(() => {
              ...
              if (loadingResources) {
                ...
                memoryContent = <span className="text-red-400">Error</span>;
              } else if (resources?.status !== "running" && resources?.memoryUsage === "N/A") {
                memoryContent = "Servidor inactivo";
              } else {
    ...
    <CardContent className="flex justify-between mt-4">
      <div className="flex items-center gap-4">
        <div className="flex items-center">
          ...
          <span className="text-xs text-gray-400 font-minecraft">{error ? "Desconectado" : hasErrors ? "Con errores" : isRealTime ? "Tiempo real activo" : "Tiempo real pausado"}</span>
        </div>
        {lastUpdate && !error && (
      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div>
          ...
          <CardDescription className="text-gray-300">
            ...
            {filteredLogEntries.length > 0 && <span className="ml-2 text-emerald-400">({filteredLogEntries.length} entradas)</span>}
          </CardDescription>
        </div>
      </CardHeader>
