  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Opciones avanzadas para la configuración de tu servidor
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Imagen Docker a utilizar (por defecto: itzg/minecraft-server:latest)
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Versión específica de Minecraft a utilizar
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Zona horaria para el servidor (ej: America/Santiago, Europe/Madrid)
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Tiempo en minutos antes de expulsar a jugadores inactivos (0 para
            desactivar)
          </p>
        </div>
...
./modpacks:/modpacks:ro"
          ...
          />
          <p className="text-xs text-muted-foreground">
            Mapeos de volúmenes Docker (uno por línea, formato:
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Tiempo en segundos a esperar antes de detener forzosamente el
            servidor
          </p>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Switch
              id="rollingLogs"
              checked={config.rollingLogs}
              onCheckedChange={(checked) =>
                updateConfig("rollingLogs", checked)
              }
            />
          </div>
          <p className="text-xs text-muted-foreground">
            Activar rotación de logs para evitar que crezcan demasiado
          </p>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Switch
              id="execDirectly"
              checked={config.execDirectly}
              onCheckedChange={(checked) =>
                updateConfig("execDirectly", checked)
              }
            />
          </div>
          <p className="text-xs text-muted-foreground">
            Ejecutar Java directamente en lugar de usar scripts de inicio (mejor
            rendimiento)
          </p>
        </div>
...
MAX_TICK_TIME=60000"
          ...
          />
          <p className="text-xs text-muted-foreground">
            Variables de entorno adicionales para el contenedor (una por línea,
            formato: CLAVE=VALOR)
          </p>
        </div>
      </CardContent>
